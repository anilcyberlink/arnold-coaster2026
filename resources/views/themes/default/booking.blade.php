...
<section class="uk-section uk-booking bg-white uk-position-relative">
  <div class="uk-container" uk-scrollspy="target:[uk-scrollspy-class], img, h1, h2, h3, h4, h5, h6, hr, .uk-button, li, p; cls: uk-animation-slide-top-medium; delay: 50; repeat: false;">
      ...
      <div class="uk-width-expand@m">
        <form class="uk-grid-medium" id="myForm" uk-grid method="POST" action="{{ route('post-trip') }}">
          ...
          <div class="uk-width-1-2@s">
            ...
            <input class="uk-input" name="phone" id="contactno" type="tel" placeholder="Enter number with country code">
          </div>
          <!--  -->
          <!--  -->
          <div class="uk-width-1-1">
          ...
          <div class="uk-width-1-1">
            <label>
              <input class="uk-checkbox" type="checkbox" value="1" name="terms_conditions" placeholder=""> I accept terms and Conditions <a href="{{url('info/'.$terms->uri)}}" target="_blank" class="text-primary">
