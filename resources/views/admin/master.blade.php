        ...
        <header class="navbar navbar-fixed-top">
            <div class="navbar-branding">
                <a class="navbar-brand" href="{{ url('/') }}" target="_blank">
                    @if ($setting->logo)
                    <img src="{{ asset('uploads/original/' . $setting->logo) }}" alt="{{ config('app.name') }}" width="150"/>
                    @else
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                <a href="avoid:javascript;" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="{{ asset(env('PUBLIC_PATH') . 'assets/img/avatars/1.png') }}" alt="avatar" class="mw30 br64 mr15">{{ Auth::user()->name }}<span class="caret caret-tp hidden-xs"></span></a>
                ...
                <li class="dropdown-footer">
                    <a class="animated animated-short fadeInUp" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><span class="fa fa-power-off pr5"></span>{{ __('Logout') }}</a>
            ...
            <div class="sidebar-left-content nano-content">
                ...
                <ul class="nav sidebar-menu">
                   ...
                   <li class="{{ (Request::segment(2) == 'dashboard')?'active':'' }}">
                    ...
                    <li class="">
                @if(Request::segment(2) == 'posttype' || Request::segment(2) == 'postcategory' || Request::segment(2) == 'company' || Request::segment(2) == 'terms-and-polices' || Request::segment(2) == 'festive-celerbations' || Request::segment(2) == 'local-experiences' || Request::segment(2) == 'contact-us')
               ...
               @if(Request::segment(2) == 'expedition'||Request::segment(2) == 'tour-trip'||Request::segment(2) == 'region'||Request::segment(2) == 'trip-region'||Request::segment(2) == 'activity'||Request::segment(2) == 'trip'||Request::segment(2) == 'tripgroup'||Request::segment(2) == 'banner-trip')
                ...
                <? */?>
                   <li class="">
               @if(Request::segment(1) == 'contact-us'||Request::segment(1) == 'admin-trip-booking'||Request::segment(1) == 'category-inquiry'||Request::segment(1) == 'tailor-made'||Request::segment(1) == 'trip-inquiry'||Request::segment(1) == 'trip-customize')
                    <a class="accordion-toggle menu-open">
                    @else
                     <a class="accordion-toggle">
                     @endif
...
?>
    ...
    <!--<script src="https://cdn.tiny.cloud/1/g3e9kv831pbj6lpanxhz2q43uw9ut5demo6pmdtv3nycypny/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>-->
